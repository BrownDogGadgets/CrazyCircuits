...
//Change the SpeakerOutput Pin as well as the Raw pin if you're using a Robotics board or standard Arduino board.
#define SpeakerOutput 16
int analog = 14; // Common resistor connected to analog pin 0 outside leads to ground and +5V 
