...
This project was originally designed, coded, and presented by youtube author RobotJax.

Libraries:

TM1637 - Download from GitHub and Manually Install
DHT11 - Do a search for the Library through the Arduino IDE. You'll want the Adafruit version 1.23, NOT the newer 1.3.
